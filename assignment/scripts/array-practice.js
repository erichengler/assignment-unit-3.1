...
let favoriteFoods = [ 'cornbread', 'chicken', 'bacon', 'oranges' ];
...
favoriteFoods.splice(1, 1, 'quesadillas' );
console.log( 'The foods are now', favoriteFoods );

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
favoriteFoods.sort();
console.log( 'Foods in alphabetical order are', favoriteFoods );

favoriteFoods.sort().reverse();
console.log( 'Foods in reverse alphabetical order are', favoriteFoods );
